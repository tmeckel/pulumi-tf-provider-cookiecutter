...
| `terraform_sdk_version`                | The Terraform SDK version that is in use by the Terraform provider. <br> **Currently only Terraform providers using SDK V2 are supported.**                                                                                                                             |
